...
export function solution(estudiantes, deathCount, nuevo) {
    // Tu código aquí 👈
    while (deathCount > 0) { // hacemos un loop indicando que si deathCount es mayor a 0.
      estudiantes.pop() // eliminamos el ultimo elemento del array
      deathCount--; // restamos la variable
    }
  
    estudiantes.push(nuevo); // luego agregamos un push para agregar los nuevos elementos
    return estudiantes; // y al final retornamos la variable estudiante 
